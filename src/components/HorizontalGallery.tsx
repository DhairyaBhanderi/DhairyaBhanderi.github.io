...
const projects = [
  {
    ...
    description:
      "Engineered scalable Model Context Protocol servers enabling tool invocations, prompt management, and resources across 40+ AI-powered applications.",
  ...
  },
  {
    ...
    description:
      "Fine-tuned Llama model for threat classification, integrated with RAG pipelines for retrieval-augmented cybersecurity analysis.",
  ...
  },
  {
    ...
    description:
      "Developed AI-powered contract analysis tool for clause identification and risk assessment with semantic search capabilities.",
  ...
  },
  {
    ...
    description:
      "Architected comprehensive EHR platform with appointment scheduling, billing, and analytics dashboards.",
